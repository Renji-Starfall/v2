...
module.exports = {
  ...
  onStart: async function ({ api, event }) {
    ...
    const loading = await api.sendMessage(
      "⛩ Opening a portal to anime land... hang tight, Senpai! 🚀", 
      event.threadID
    );
    ...
    try {
      ...
      writer.on("finish", () => {
        api.sendMessage({
          body:
            ...
            "👨‍💻 Crafted with ❤ by: Mueid Mursalin Rifat\n" +
      ...
      api.sendMessage(
        "⚠ Failed to deliver your anime magic. Either the API is resting 😴 or the file is too big (25MB+).", 
        event.threadID, 
        event.messageID
      );
    }
